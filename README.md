...
* 🔭 I currently work in Enterprise Architecture with .NET 10 and AI Agent Orchestration.
* 🌱 I'm heavily focused on DevOps automation, PowerShell scripting, and cloud infrastructure.
* 🤖 I believe in the power of AI to boost developer productivity (check out my [AGENTS.md](./AGENTS.md)!).
* ⚡ Fun fact: I automate everything I can; if I have to do it twice, I write a script.

## 🛠️ Tech Stack

<p>
  <img alt="C Sharp" src="https://img.shields.io/badge/C%23-239120?style=for-the-badge&logo=.net&logoColor=white" />
